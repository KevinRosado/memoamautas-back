...
create table memo_amautas.person(
...
create table memo_amautas.progreso_sesion(
                                             ...
                                             cant_progreso int,
                                             foreign key (cod_persona) references memo_amautas.person (id_persona),
                                             foreign key (cod_sesion) references memo_amautas.session (id_sesion)
);
create table memo_amautas.deck(
                                  ...
                                  foreign key (cod_autor) references memo_amautas.person (id_persona),
                                  foreign key (cod_sesion) references memo_amautas.session (id_sesion)
);
create table memo_amautas.tarjeta(
                                     ...
                                     foreign key (cod_mazo) references memo_amautas.deck (id_mazo)
);
create table memo_amautas.mazo_seguido(
                                          ...
                                          foreign key (cod_seguidor) references memo_amautas.person(id_persona),
                                          foreign key (cod_mazo) references memo_amautas.deck (id_mazo)
);
create table memo_amautas.etiqueta_curso(
                                            ...
                                            foreign key (cod_curso) references memo_amautas.course (id_curso),
                                            foreign key (cod_etiqueta) references memo_amautas.tag (id_etiqueta)
);
